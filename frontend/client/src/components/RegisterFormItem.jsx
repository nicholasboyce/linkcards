...
const RegisterFormItem = ({ id, text, type, length, name }) => {
    ...
    return (
        <p className={styles.registerFormItem}>
            ...
            <input ref={inputRef} type={type} id={id} name={name} aria-describedby='registerFormError' required onChange={validateInput} onInvalid={(e) => e.preventDefault()} minLength={length}/>
