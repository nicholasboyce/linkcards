    ...
    if (result !== null) {
        ...
        return (
            <main className={styles.main}>
                ...
                {
                    (status.user === user) && 
                    <Link to={`/${user}/edit`} className={styles.editLink} aria-label='Edit'>
                        <svg className={styles.edit} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" role='presentation'>
